            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center mt-0 m-b-15">
                        <a href="{{ url('register') }}" class="logo logo-admin"><img src="{{ asset('assets') }}/images/dalusy.jpg" height="24" alt="logo"></a>
                    </h3>
                    ...
                    <div class="p-3">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                           @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control @error('name') is-invalid @enderror" type="email"  name="email" value="{{ old('email') }}" required="" placeholder="Email Address">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control" type="password" name="password_confirmation" required="" placeholder="Password Confirm">
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-12">
                                    <label for="file">Images profile <i>*( optional )</i> </label>
